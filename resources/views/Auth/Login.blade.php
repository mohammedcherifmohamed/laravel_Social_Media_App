...
@endif
    ...
    <div class="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
      <form action="{{route('login.post')}}" method="POST" class="space-y-6">
       @csrf
        ...
        <div class="flex items-center justify-between">
          ...
          <div class="text-sm">
            <a href="{{route('forgot.load')}}" class="text-blue-600 hover:text-blue-500 font-medium">
              Forgot password?
            </a>
          </div>
        </div>
      ...
      <div class="grid grid-cols-2 gap-3">
        <a href="{{route('AuthGoogle')}}" class="flex items-center justify-center px-4 py-2 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-blue-500 transition duration-200">
