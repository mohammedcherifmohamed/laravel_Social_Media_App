<div>
        ...
        <div class="bg-white rounded-lg shadow p-4">
          <div class="flex items-center space-x-3 mb-2">
            <img src="{{\Illuminate\Support\Facades\Storage::url( $user_image)}}" class="h-9 w-9 rounded-full"/>
            <div>
          ...
          <img src="{{asset("posts_images/". $image)}}" class="rounded-lg mb-2 max-h-60 w-full object-cover"/>
